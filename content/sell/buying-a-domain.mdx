...
[the widget](/docs/widget-sdk/overview), not just console users. Call
...
[SDK reference](/docs/widget-sdk/reference#events--callbacks) for the event
shape and the
[Registrar API reference](/docs/api-reference/registrar/startDomainCheckout) for
both endpoints.
